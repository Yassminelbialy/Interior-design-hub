...
class FacebookController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('CompanyAdmin.facebook' , ['dataOfPosts' => Fbpost::all()]);
    }
    ...
    {
        return view('CompanyAdmin.addImage');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/companypanel/fbPosts');
    ...
    {
        return view('CompanyAdmin.facebookEdit',['facebppkImage' => Fbpost::find($id)]);
    }

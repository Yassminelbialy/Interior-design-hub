...
<a href="/companypanel/sliderImage/create" class="btn btn-info mt-2 ml-2">Add New Image For Slider</a>
  ...
  <thead>
    ...
    @foreach($slider as $slider_img)
        <tr>
            ...
            <td>
                {!! Form::open(['route' => ['company.sliderImage.destroy', $slider_img->id] , 'method'=>'delete']) !!}

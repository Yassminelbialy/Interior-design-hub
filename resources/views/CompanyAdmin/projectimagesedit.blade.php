...
{{ Form::model($data,['route' => ['company.project.images.update',$id,$data->id],'enctype' => 'multipart/form-data','method'=>'PUT'])}}
<div class="form-group text-light">
  ...
  <div class="form-group">
    ...
    <div class="custom-file form-control  " style="width: 50%">
      <br>
      {!! Form::file('image', ['class'=>'custom-file-input form-control','id'=>"validatedCustomFile",'onchange'=>'showimage(this)']) !!} <label class="custom-file-label" for="validatedCustomFile">Choose file...</label>

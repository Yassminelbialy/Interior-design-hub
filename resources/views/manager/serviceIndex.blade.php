...
<div class="text-center">
  <table class="table table-dark" style="background-color: rgba(0,0,0,0.5);">
    <thead>
      <tr>
        <td colspan="4"><a href="{{route('manager.service.index')}}"><i class="fas fa-trash fa-4x" style="color: blue"></i></a></td>
        <td colspan="4"><a href="{{route('manager.service.create')}}"><i class="fas fa-plus fa-4x" style="color: blue"></i></a></td>
      </tr>
      <tr>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>{{$service->price}}</td>
        <td>
          <a href="{{ route('manager.service.edit', $service->id) }}"> <i class="fas fa-edit fa-2x" style="color: blue"></i></a>
        </td>
        <td>
          {!!Form::open(['route'=>[ 'manager.service.destroy' , $service->id],'method'=>'delete','style'=>' display: inline-block '])!!}
